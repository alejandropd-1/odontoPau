  ...
  return (
    <footer className="w-full border-t border-slate-100 bg-white py-12">
      <div className="flex flex-col md:flex-row justify-between items-center px-8 gap-8 max-w-7xl mx-auto">
        <div className="font-extrabold text-orange-600 text-2xl tracking-tight">Paula Gualtieri</div>
        
        <div className="text-sm font-medium text-slate-400">
          © {new Date().getFullYear()} Paula Gualtieri. Todos los derechos reservados.
        </div>
