...
- [x] 3.3 Entregar el borrador a Paula y registrar correcciones de diagnostico, tecnica, tiempos, resultados, cifras y testimonio
- [x] 3.4 Aplicar la revision clinica y mover el piloto a `technical_review` sin publicarlo
...
- [x] 4.4 Trasladar la aprobacion y operacion de derivados al OpenSpec independiente `preparar-redes-sociales-editoriales`
...
- [x] 5.8 Presentar preview al responsable del sitio y esperar aprobacion explicita antes de publicar o desplegar

## 6. Publicacion controlada

- [x] 6.1 Cambiar el piloto a `published` solo despues de las aprobaciones clinica, editorial, tecnica y visual
- [x] 6.2 Mezclar a `main` mediante el flujo Git/Netlify autorizado y verificar la URL, sitemap, tratamiento relacionado y CTA en produccion
- [x] 6.3 Trasladar el paquete social, enlaces medibles y calendario al OpenSpec `preparar-redes-sociales-editoriales`
- [x] 6.4 Documentar fecha, version, aprobaciones no sensibles y cualquier desviacion en OpenSpec y Git
...
- [x] 7.4 Abrir un cambio OpenSpec por cada mejora estructural y agrupar publicaciones editoriales simples en lotes trazables
- [x] 7.5 Archivar este cambio cuando la infraestructura y el piloto web esten implementados y validados, con redes transferidas a su propio OpenSpec
