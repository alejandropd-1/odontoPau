...
- **THEN** no se copia a `public` ni se utiliza en web o redes
...
- **THEN** se registra la correccion, se revisan sus derivados sociales y se vuelve a validar antes de publicar
