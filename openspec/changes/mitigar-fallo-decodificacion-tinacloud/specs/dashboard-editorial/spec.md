...
#### Scenario: Ayuda antes del dashboard
- **WHEN** el admin aún no cargó el dashboard porque falta una sesión válida o falla la comprobación de schema
- **THEN** el aviso y los contactos siguen accesibles con teclado y en móvil, sin exigir una lectura de documentos, habilitar edición local ni sustituir el login original de TinaCloud
