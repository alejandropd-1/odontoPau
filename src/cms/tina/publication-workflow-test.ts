...
assert.match(dashboard, /historyPagination\.key === historyPaginationKey\s*\? historyPagination\.count\s*: 5/);
assert.match(dashboard, /displayedHistoryView\.movements\.slice\(0, visibleHistoryCount\)/);
assert.match(dashboard, /setHistoryPagination\(\{\s*key: historyPaginationKey,\s*count: visibleHistoryCount \+ 5,/);
